        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
                    ...
                    if (!canceled) {
                        ...
                        try {
                            ...
                            if (incomingRinging) {
								...
								service1.setClassName(mContext, "com.android.settings.SoundSettings");
								ContentResolver res1 = mContext.getContentResolver();
								if(1 == Settings.System.getInt(res1, Settings.System.HAPTIC_FEEDBACK_ENABLED,0))//when setting feedback enable
								{
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
					...
					service2.setClassName(mContext, "com.android.settings.SoundSettings");
					ContentResolver res2 = mContext.getContentResolver();
					if(1 == Settings.System.getInt(res2, Settings.System.HAPTIC_FEEDBACK_ENABLED,0))//when setting feedback enable
					{
						performHapticFeedbackLw(null, HapticFeedbackConstants.KEYBOARD_TAP, true); //启动震动 by syhost
					}
			...
			if (down && repeatCount == 0) {
				...
				service3.setClassName(mContext, "com.android.settings.SoundSettings");
				ContentResolver res3 = mContext.getContentResolver();
				if(1 == Settings.System.getInt(res3, Settings.System.HAPTIC_FEEDBACK_ENABLED,0))//when setting feedback enable
				{
					performHapticFeedbackLw(null, HapticFeedbackConstants.KEYBOARD_TAP, true); //启动震动 by syhost
				}       
			}
            if (Settings.Secure.getInt(mContext.getContentResolver(),
                ...
                if (down && repeatCount == 0) {
					...
					// right now to interact with applications.
					attrs = win != null ? win.getAttrs() : null;
					Intent service4 = new Intent();
					service4.setClassName(mContext, "com.android.settings.SoundSettings");
					ContentResolver res4 = mContext.getContentResolver();
					if(1 == Settings.System.getInt(res4, Settings.System.HAPTIC_FEEDBACK_ENABLED,0))//when setting feedback enable
					{
						performHapticFeedbackLw(null, HapticFeedbackConstants.KEYBOARD_TAP, true); //启动震动 by syhost
					}
